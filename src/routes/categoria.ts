...
class Categoria {
    ...
    async getCategoria(req: Request, res: Response) {
        ...
        try {
            ...
            categoriaBD = await UsuarioModel.populate(categoriaBD, { path: "usuario", select: 'nombre role' });
    ...
    async deleteCategoria(req: Request, res: Response) {
        ...
        exponerRutas() {
            this.router.get('/', [verificaToken, verificaRol], this.getCategoria);
            this.router.get('/:id', [verificaToken, verificaRol], this.getCategoriaId);
            this.router.post('/', [verificaToken, verificaRol], this.postCategoria);
            this.router.put('/:id', [verificaToken, verificaRol], this.putCategoria);
            this.router.delete('/:id', [verificaToken, verificaRol], this.deleteCategoria);
